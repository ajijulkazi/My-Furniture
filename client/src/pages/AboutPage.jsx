          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="bg-white shadow rounded-lg overflow-hidden">
              ...
              <div className="p-4">
                ...
                <p className="text-gray-700 font-bold">$299</p>
                <button onClick={() => addToCart(product)} className="bg-gray-900 text-white py-2 px-4 mt-4 rounded hover:bg-gray-800">
                  Add to Cart
                </button>
              </div>
            </div>
            <div className="bg-white shadow rounded-lg overflow-hidden">
              ...
              <div className="p-4">
                ...
                <p className="text-gray-700 font-bold">$399</p>
